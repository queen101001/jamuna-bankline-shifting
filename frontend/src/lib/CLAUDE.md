...
- `parseValidationExcel.js` — Parses uploaded XLSX with 2-row header format. Returns `{years, data}`. No sign transformation applied (negative = erosion, positive = deposition for both banks).
